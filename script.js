...
=======
>>>>>>> 4c694cc70900c3b9f3e8301c6a615e280c6fbed0
// Game State
let currentTarget = 1;
...
=======
 * Renders the 5x5 grid with numbers in a checkerboard pattern
>>>>>>> 4c694cc70900c3b9f3e8301c6a615e280c6fbed0
 */
...
=======
    numbers.forEach((num, index) => {
        ...
        // Calculate checkerboard pattern (alternating white/black tiles)
        const row = Math.floor(index / 5);
        const col = index % 5;
        const isWhiteTile = (row + col) % 2 === 0;
